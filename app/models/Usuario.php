...
class Usuario
{
    ...
    public function crearUsuario() //listo
    {
 
        $tipoAux= AccesoDatos::retornarObjetoActivoPorCampo($this->tipo, "id", "tipo_usuario", "nombre");
        $usuarioAux =  AccesoDatos::retornarObjetoPorCampo($this->dni, "dni", "usuario", "Usuario");
        var_dump($tipoAux);
        var_dump($usuarioAux);
